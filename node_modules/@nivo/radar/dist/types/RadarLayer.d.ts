...
export declare const RadarLayer: <D extends Record<string, unknown>>({ data, item: key, colorByKey, fillByKey, radiusScale, rotation, angleStep, curveFactory, borderWidth, borderColor, fillOpacity, blendMode, }: RadarLayerProps<D>) => import("react/jsx-runtime").JSX.Element;
export {};
