...
export declare const RadarSlices: <D extends Record<string, unknown>>({ data, keys, getIndex, formatValue, colorByKey, radius, rotation, angleStep, tooltip, onClick, }: RadarSlicesProps<D>) => import("react/jsx-runtime").JSX.Element;
export {};
