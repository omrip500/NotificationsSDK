...
import { Box, CssMixBlendMode, Dimensions, MotionProps, PropertyAccessor, ValueFormat, ClosedCurveFactoryId, DotsItemSymbolComponent, SvgDefsAndFill } from '@nivo/core';
...
export type MouseEventHandler<RawDatum, ElementType = HTMLCanvasElement> = (datum: RawDatum, event: MouseEvent<ElementType>) => void;
