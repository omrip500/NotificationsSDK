...
export declare const RadarDots: <D extends Record<string, unknown>>({ data, keys, getIndex, colorByKey, radiusScale, rotation, angleStep, symbol, size, color, borderWidth, borderColor, enableLabel, label, formatValue, labelYOffset, }: RadarDotsProps<D>) => import("react/jsx-runtime").JSX.Element;
export {};
