...
export declare const RadarGrid: <D extends Record<string, unknown>>({ indices, levels, shape, radius, rotation, angleStep, label, labelOffset, }: RadarGridProps<D>) => import("react/jsx-runtime").JSX.Element;
export {};
